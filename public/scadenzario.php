...
$badgeText = 'Lettura dedicata dello scadenzario aperto';
$dataset = $filteredDues;
$totalDataset = $openDues;
$pageTitle = 'Scadenzario generale';
$pageDescription = 'Pagina dedicata alle scadenze ancora aperte, con filtri, stato pagamenti e gestione rate in una vista più leggibile.';
$emptyMessage = 'Nessuna fattura aperta trovata con i filtri selezionati.';
?>
<!DOCTYPE html>
<html lang="it">
<head>
...
<div class="container">
    <div class="page-actions">
        ...
        <span class="pill"><?php echo $badgeText; ?></span>
    </div>
    ...
    <section class="card">
        ...
        <p class="muted"><?= htmlspecialchars($pageDescription) ?></p>
    </section>
    ...
    <section class="card">
        <div class="table-tools">
            ...
            <div class="pill"><?= count($dataset) ?> risultati / <?= count($totalDataset) ?> totali</div>
        </div>
