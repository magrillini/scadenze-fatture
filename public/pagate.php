...
$badgeText = 'Archivio fatture pagate';
$dataset = $filteredPaidDues;
$totalDataset = $paidDues;
$pageTitle = 'Fatture pagate';
$pageDescription = 'Qui trovi tutte le fatture già marcate come pagate, con gli stessi filtri di ricerca dello scadenzario generale.';
$emptyMessage = 'Nessuna fattura pagata trovata con i filtri selezionati.';
?>
<!DOCTYPE html>
<html lang="it">
<head>
