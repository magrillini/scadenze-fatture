...
function bindThreeCharFilter(config) {
    ...
    if (!inputElement || !showAllElement || !hintElement || !resultsContainer || !rows.length) {
        return;
    }
...
bindThreeCharFilter({
    ...
    resultsId: 'customer_chart_results'
});
...
bindThreeCharFilter({
    ...
    resultsId: 'customer_rating_results'
});
</script>
</body>
</html>
